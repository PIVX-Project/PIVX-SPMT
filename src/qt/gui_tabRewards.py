...
class TabRewards_gui(QWidget):
    ...
    def initRewardsForm(self):
        ...
        self.addrAvailLine.setToolTip("Available Rewards = MN Balance - Collateral")
        ...
        self.btn_selectAllRewards.setToolTip("Select all available UTXOs except the collateral")
        ...
        self.feeLine.setMaximum(0.1)
        self.feeLine.setToolTip("Insert a small fee amount")
        self.feeLine.setValue(0.01)
