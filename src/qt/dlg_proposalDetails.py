...
class Ui_proposalDetailsDlg(object):
    def setupUi(self, PropDetailsDlg):
        ...
        body.addRow(QLabel("<b>Hash: </b>"), QLabel(PropDetailsDlg.data.Hash))
        body.addRow(QLabel("<b>FeeHash: </b>"), QLabel(PropDetailsDlg.data.FeeHash))
        ...
        body.addRow(QLabel("<b>PaymentAddress: </b>"), QLabel(PropDetailsDlg.data.PaymentAddress))
